...
if(CXX11_COMPILER)
  ...
  MESSAGE(FATAL_ERROR "Your C++ compiler version (${CMAKE_CXX_COMPILER_ID} ${COMPILER_VERSION}) is not compatible with C++11. Please use a fully C++11 compliant compiler.")
endif(CXX11_COMPILER)

# platform dependent preprocessor defines
if (WIN32)
  if (CYGWIN)
    ADD_DEFINITIONS("-D_PLATFORM=PF_CYGWIN")
  elseif (MINGW)
    ADD_DEFINITIONS("-D_PLATFORM=PF_MINGW")
  else()
    ADD_DEFINITIONS("-D_PLATFORM=PF_WIN32")
  endif()
elseif (UNIX)
  if (${CMAKE_SYSTEM_NAME} MATCHES "Darwin")
    ADD_DEFINITIONS("-D_PLATFORM=PF_MACOSX")
  else()
    ADD_DEFINITIONS("-D_PLATFORM=PF_LINUX")
  endif()
else()
...
if (CMAKE_COMPILER_IS_GNUCC)
   ...
   add_definitions("-D_FUNC=__PRETTY_FUNCTION__")
elseif(MSVC)
   message(STATUS "Using MSVC-specific preprocessor identifiers and options")
   add_definitions("-D_FUNC=__FUNCTION__")
   ...
   add_definitions("-D_FUNC=__func__")
endif()
